...
import com.example.simbirsoftpracticeapp.exceptions.ExpectedException;
...
public class RxCreatingTraining {
    ...
    public Observable<Integer> expensiveMethodResult() {
        Observable<Integer> result = Observable.empty();
        return result.doOnSubscribe(disposable -> {
            expensiveMethod();
        });
    }
    ...
    public Observable<Integer> onlyError() {
        return Observable.error(ExpectedException::new);
    }
